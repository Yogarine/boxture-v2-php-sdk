...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'http://staging.localexpress.nl/api/v2';
    ...
    {
        $report  = 'PHP SDK (Boxture\V2) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return array(
          array(
            "url" => "//staging.localexpress.nl/api/v2",
