...
/**
 * PatchShipments Class Doc Comment
 *
 * @category Class
 * @description Update shipment information, informational changes only
 * @package  Boxture\V2
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PatchShipments implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patchShipments';
    ...
    protected static $openAPITypes = [
        'shipment' => '\Boxture\V2\Model\ShipmentUpdateRequest'
    ];
     ...
     * Gets shipment
     *
     * @return \Boxture\V2\Model\ShipmentUpdateRequest
     */
     ...
     * Sets shipment
     *
     * @param \Boxture\V2\Model\ShipmentUpdateRequest $shipment shipment
     *
     * @return $this
     */
