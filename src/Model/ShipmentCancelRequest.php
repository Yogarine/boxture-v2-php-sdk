...
class ShipmentCancelRequest implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['cancelledAt'] = isset($data['cancelledAt']) ? $data['cancelledAt'] : null;
    }
     ...
     * Sets cancelledAt
     *
     * @param \DateTime|null $cancelledAt Cancel date/time, leave empty to use current date/time
     *
     * @return $this
     */
