...
/**
 * ShipmentAssignRequest Class Doc Comment
 *
 * @category Class
 * @package  Boxture\V2
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ShipmentAssignRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipmentAssignRequest';
    ...
    {
        $this->container['assignedAt'] = isset($data['assignedAt']) ? $data['assignedAt'] : null;
     ...
     * Sets assignedAt
     *
     * @param string|null $assignedAt assignedAt
     *
     * @return $this
     */
